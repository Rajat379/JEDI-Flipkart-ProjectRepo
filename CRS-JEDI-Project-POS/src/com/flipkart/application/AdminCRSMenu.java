...
public class AdminCRSMenu {
	...
	public static void showChoices()
	{
		...
		System.out.println("Enter 7 to view professors");
		System.out.println("Enter 8 to view students");
		System.out.println("Enter 9 to view courses");
		System.out.println("Enter 10 to approve student request");
